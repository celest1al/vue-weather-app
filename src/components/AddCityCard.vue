<template>
      <div @click="toAddCityPage" class="add__card" :class="{'add__card-dark': darkMode}">
            ...
            <div class="body__container">
                  ...
                  <svg class="city__illustration" id="City_Illustration" data-name="City Illustration" viewBox="1367.8 616.6 403.6 331.4">
                        <defs>
                              <svg:style>
                                    .cls-1 { fill: #a1ffd9 } .cls-2 { fill: #f5f5f5 } .cls-3 { fill: #c4d1fe } .cls-6 { fill: #bffee6 } .cls-7 { fill: #31feae
                                    } .cls-11 { fill: #7d9cff } .cls-14 { fill: #5f84fb } .cls-17, .cls-19 { fill: none }
                                    .cls-17 { stroke: #fff; stroke-width: 2px } .cls-18 { fill: #606cb9 } .cls-19 { stroke:
                                    #a1ffd9; stroke-width: 3px }
                              </svg:style>
                        </defs>
